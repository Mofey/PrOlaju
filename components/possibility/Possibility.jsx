...
const Possibility = () => (
  <div className={`${styles.prolaju__possibility} section__padding`} id="possibility">
    ...
    <div className={styles.prolaju__possibility_content}>
      ...
      <p>Do not have doubts. If you can think it, you can get it.<br />Here&apos;s a quote by Denzel Washington; &apos;&apos;True desire in the heart for anything good is God&apos;s proof to you, sitting beforehand to indicate that it&apos;s yours already.&apos;&apos;.</p>
      <h4>Request Early Access to Get Started</h4>
    </div>
  </div>
);
